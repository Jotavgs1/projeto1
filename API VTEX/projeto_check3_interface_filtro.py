...
import pytz
from PySide6.QtWidgets import QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QHBoxLayout, QWidget, QLabel, QDateEdit, QPushButton, QMessageBox, QComboBox
...
class OrdersDashboard(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("VTEX Orders Dashboard - Date and Status Filter")
    ...
    def apply_filter(self):
        ...
        # Fetch orders
        orders_data, subtotal = fetch_orders(start_date, end_date, status_filter)
